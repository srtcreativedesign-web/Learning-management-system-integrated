...
function SidebarMenuSubButton({
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        'text-slate-600 hover:bg-slate-100 hover:text-slate-900 active:bg-slate-100/80 flex h-8 min-w-0 items-center gap-2 overflow-hidden rounded-md px-2.5 outline-hidden transition-colors duration-150 text-xs font-medium',
        'data-[active=true]:bg-[#419CC3]/10 data-[active=true]:text-[#419CC3] data-[active=true]:font-bold',
        className
      )}
      {...props}
    />
