...
## Corpus Check
- 195 files · ~169,485 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1816 nodes · 2205 edges · 134 communities (90 shown, 44 thin omitted)
...
- `FindingsScreen()` --calls--> `useAuth()`  [EXTRACTED]
  mobile-app/app/(tabs)/findings.tsx → mobile-app/src/context/AuthContext.tsx
- `LoginScreen()` --calls--> `useAuth()`  [EXTRACTED]
  mobile-app/app/index.tsx → mobile-app/src/context/AuthContext.tsx
- `CustomTabBar()` --calls--> `useAuth()`  [EXTRACTED]
  mobile-app/src/components/navigation/CustomTabBar.tsx → mobile-app/src/context/AuthContext.tsx
...
Cohesion: 0.29
Nodes (10): LoginScreen(), HomeScreen(), OutletItem, OutletsScreen(), GradeBadge(), useAuth(), fetchAuditInspectionsApi(), fetchInHouseSessionsApi() (+2 more)
...
### Community 11 - "react"
Cohesion: 0.05
Nodes (10): App(), queryClient, EmptyStateProps, PageHeaderProps, ProtectedRouteProps, StatCardProps, AppSidebar(), CommonControlledStateProps (+2 more)
...
### Community 76 - "findings.tsx"
Cohesion: 0.20
Nodes (18): DEMO_ACCOUNTS, SopItem, SopPoint, ProfileScreen(), BrandHeader(), BrandHeaderProps, BrandStatusScrim(), Button() (+10 more)
...
### Community 127 - "services/api.ts"
Cohesion: 0.11
Nodes (21): FindingsScreen(), AuditInspectionBottomSheet(), AuditInspectionBottomSheetProps, styles, { height: SCREEN_HEIGHT }, InHouseAssessmentBottomSheet(), InHouseAssessmentBottomSheetProps, styles (+13 more)

### Community 129 - "mobile-app/src/context/AuthContext.tsx"
Cohesion: 0.13
Nodes (13): AUDITOR_TABS, CustomTabBar(), styles, TabMeta, TRAINER_TABS, AuthContext, AuthContextType, AuthProvider() (+5 more)
...
## Knowledge Gaps
- **837 isolated node(s):** `$schema`, `collection`, `sourceRoot`, `deleteOutDir`, `seed` (+832 more)
...
- **Why does `react` connect `react` to `sidebar.tsx`, `mobile-app/src/context/AuthContext.tsx`, `TrainingAnalytics.tsx`, `home.tsx`, `LeaderboardView.tsx`, `LineChartCard.tsx`, `Avatar.tsx`, `primitives/animate/tooltip.tsx`, `primitives/radix/sheet.tsx`, `components/radix/sheet.tsx`, `highlight.tsx`, `frontend/src/context/AuthContext.tsx`, `dropdown-menu.tsx`, `dialog.tsx`, `select.tsx`, `components/animate/tooltip.tsx`, `table.tsx`, `slot.tsx`, `checkbox.tsx`, `card.tsx`, `InHouseSessionsView.tsx`, `LibraryQuizGenerate.tsx`, `LibraryView.tsx`, `DynamicInputList.tsx`, `DataTable.tsx`, `StatusBadge.tsx`, `QuizBuilder.tsx`, `ChecklistBuilder.tsx`, `AuditAnalytics.tsx`, `InHouseChecklistBuilder.tsx`, `plugins`, `SopViewer.tsx`, `QuizHistoryView.tsx`, `OutletManagement.tsx`, `EmployeeManagement.tsx`, `findings.tsx`, `BarChartCard.tsx`, `services/api.ts`?**
