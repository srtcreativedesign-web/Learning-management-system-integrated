...
## Corpus Check
- 169 files · ~127,129 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1228 nodes · 1472 edges · 120 communities (67 shown, 53 thin omitted)
...
- `AuthContextType` --references--> `UserRole`  [EXTRACTED]
  frontend/src/context/AuthContext.tsx → frontend/src/types/auth.ts
- `AuthProvider()` --calls--> `getApiUrl()`  [EXTRACTED]
  frontend/src/context/AuthContext.tsx → frontend/src/lib/api.ts
...
Cohesion: 0.06
Nodes (30): AppController, Controller, Get, AppModule, Module, AppService, Injectable, AiService (+22 more)
...
### Community 4 - "QuizController"
Cohesion: 0.13
Nodes (10): QuizController, ApiOperation, ApiTags, Body, Controller, Get, Param, Post (+2 more)
...
### Community 11 - "react"
Cohesion: 0.07
Nodes (4): App(), queryClient, LeaderboardUser, react
...
Cohesion: 0.11
Nodes (12): InHouseController, Body, Controller, Get, Param, Post, Query, InHouseModule (+4 more)
